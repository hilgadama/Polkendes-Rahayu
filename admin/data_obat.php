...
<div class="container-contact100">
    <div class="wrap-contact100">
      <form class="contact100-form validate-form" action="?view=proses_tambah_obat" method="post">
        ...
        <label class="label-input100 text-left" for="nama_obat">Nama Obat</label>
        <div class="wrap-input100">
          <input class="input100" type="text" name="nama_obat" />
          <span class="focus-input100"></span>
        </div>
        <label class="label-input100 text-left" for="stok">Stok</label>
        <div class="wrap-input100">
...
<table class="table table-striped table-bordered table-hover dataTables-example table-wrapper-scroll-y my-custom-scrollbar">
    <thead>
      <tr class="table100-head">
        <th class="column1 text-center">Id Obat</th>
        <th class="column2 text-center">Nama Obat</th>
        <th class="column3 text-center">Stok</th>
        <th class="column4 text-center">Aksi</th>
      </tr>
    </thead>
    <?php
      $nomor=0;
    ...
    ?>
      <td><button type="button" class="btn btn-primary size" onclick="edit(<?php echo "$data2[id_obat]";?>)">Edit</button>
      <button type="button" class="btn btn-danger size" onclick="hapus(<?php echo "'$data2[nama_obat]',$data2[id_obat]";?>)">Hapus</button></td>
      </tr>
  <?php } ?>
  </table>
</div>
